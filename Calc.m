...
for i = 1:length(angles)
    ...
    totalSysDeriv = makeDeriv(sizeSample, orderSample, sizeLead, hoppingsDeriv);
    ...
    %TorqueEM{i} = TorqueCalc(totalSystem, totalSysDeriv, Energies, sampleVals, leadVals, hoppingsInter, conservative=true, EM=true);
    %TorqueSI{i} = TorqueCalc(totalSystem, totalSysDeriv, Energies, sampleVals, leadVals, hoppingsInter, conservative=true, SI=true);
    %AngularEM{i} = AngularCalc(totalSystem, Energies, sampleVals, leadVals, hoppingsInter, conservative=true, EM=true);
    %AngularSI{i} = AngularCalc(totalSystem, Energies, sampleVals, leadVals, hoppingsInter, conservative=true, SI=true);
    %HelicityEM{i} = HelicityCalc(totalSystem, Energies, sampleVals, leadVals, hoppingsInter, conservative=true, EM=true);
    %HelicitySI{i} = HelicityCalc(totalSystem, Energies, sampleVals, leadVals, hoppingsInter, conservative=true, SI=true);
    disp(['Angle: ', num2str(angles(i)), ', i=', num2str(i)])
end

%% plot
Plot(1, angles, Energies, {TransmissionEM, TransmissionSI}, Spectrum=true, Both=true, Title='Both')
Plot(1, angles, Energies, {TransmissionEM, TransmissionSI}, Spectrum=true, Both=true, Title='Both')
Plot(1, angles, Energies, {TransmissionEM, TransmissionSI}, Spectrum=true, Both=true, Title='Both')
Plot(1, angles, Energies, {TransmissionEM, TransmissionSI}, Spectrum=true, Both=true, Title='Both')
